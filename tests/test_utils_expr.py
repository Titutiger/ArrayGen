...
class TestExpr(unittest.TestCase):
    def test_basic_positive_1var(self):
        self.assertEqual(expr(lambda x: x ** 2, negative=False, loops=1), (([0,1], [1.0, 1])))

    def test_basic_negative_1var(self):
        self.assertEqual(expr(lambda x: x ** 2, negative=True, loops=1), (([-1,0,1], [1.0, 0, 1])))
